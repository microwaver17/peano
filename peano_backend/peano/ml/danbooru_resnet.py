...
#
# def resnet50_feature(pretrained=True, progress=True, top_n=6000, **kwargs):
#     r"""
#     Resnet50 model trained on the full Danbooru2018 dataset's top 6000 tags
#     7, 8層を恒等関数に置き換え、512次元の特徴量を抽出する
#     [参考]
#     https://github.com/birdManIkioiShota/DaFID-512/blob/main/danbooru-fid.py
#     https://birdmanikioishota.blog.fc2.com/blog-entry-15.html
#
#     Args:
#         pretrained (bool): kwargs, load pretrained weights into the model.
#         top_n (int): kwargs, pick to load the model for predicting the top `n` tags,
...
#             )
#
#     model[1][7] = nn.Identity()
#     model[1][8] = nn.Identity()
#
#     return model
